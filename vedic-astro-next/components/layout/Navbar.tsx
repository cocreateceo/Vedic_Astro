      ...
      <nav className="max-w-[1680px] mx-auto flex items-center px-4 xl:px-6 py-4">
        ...
        <div className="hidden xl:flex items-center gap-3 2xl:gap-4 flex-shrink-0">
          ...
          {isLoggedIn ? (
            ...
            <Link
              href="/login"
              className="btn-premium bg-gradient-to-br from-sign-primary to-sign-dark text-cosmic-bg px-4 py-2 rounded-lg font-medium transition-all inline-block whitespace-nowrap"
              onClick={() => setMenuOpen(false)}
            >
              Login / Sign Up
            </Link>
