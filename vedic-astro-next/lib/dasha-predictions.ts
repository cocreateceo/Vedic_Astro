...
const MAHA_CONTEXT: Record<string, { theme: string; focus: string[]; classical: string }> = {
  Sun: { theme: 'authority, government, and self-expression', focus: ['career recognition', 'health vitality', 'paternal relationships', 'leadership roles'], classical: 'Per BPHS: Sun Mahadasha (6 years) activates the soul\'s purpose. The native gains through government, authority, and father. Health of the heart and eyes requires attention.' },
  Moon: { theme: 'emotions, public life, and nurturing', focus: ['mental peace', 'maternal bonds', 'creative endeavors', 'travel and public dealings'], classical: 'Per BPHS: Moon Mahadasha (10 years) governs the mind and public life. The native gains through mother, travel, liquid assets, and nurturing professions.' },
  Mars: { theme: 'courage, property, and physical energy', focus: ['land and property', 'sibling relations', 'competitive success', 'physical health'], classical: 'Per BPHS: Mars Mahadasha (7 years) activates courage and property matters. The native gains through land, engineering, surgery, and competitive endeavors.' },
  Mercury: { theme: 'intellect, commerce, and communication', focus: ['business ventures', 'education', 'writing and speech', 'analytical work'], classical: 'Per BPHS: Mercury Mahadasha (17 years) governs intellect and commerce. The native gains through trade, education, writing, and all forms of communication.' },
  Jupiter: { theme: 'wisdom, fortune, and spiritual growth', focus: ['wealth accumulation', 'children', 'teaching and learning', 'dharmic pursuits'], classical: 'Per BPHS: Jupiter Mahadasha (16 years) is the period of wisdom and fortune. The native gains through righteousness, children, teaching, and spiritual growth.' },
  Venus: { theme: 'love, luxury, and artistic expression', focus: ['marriage harmony', 'financial comfort', 'creative arts', 'social pleasures'], classical: 'Per BPHS: Venus Mahadasha (20 years) governs love, luxury, and the arts. The native gains through marriage, entertainment, beauty, and material comfort.' },
  Saturn: { theme: 'discipline, karma, and endurance', focus: ['career building', 'chronic health', 'service to others', 'long-term investments'], classical: 'Per BPHS: Saturn Mahadasha (19 years) tests endurance and rewards discipline. The native gains through persistent effort, service, and democratic institutions.' },
  Rahu: { theme: 'ambition, foreign connections, and transformation', focus: ['unconventional gains', 'technology', 'foreign travel', 'sudden changes'], classical: 'Per BPHS: Rahu Mahadasha (18 years) brings worldly ambition and transformation. The native gains through foreign connections, technology, and unconventional means.' },
  Ketu: { theme: 'spirituality, detachment, and past karma', focus: ['spiritual insight', 'letting go', 'healing', 'mystical experiences'], classical: 'Per BPHS: Ketu Mahadasha (7 years) activates spiritual liberation. The native gains through renunciation, healing, esoteric knowledge, and past-life merit.' },
};
...
const ANTAR_EFFECTS: Record<string, Record<string, string>> = {
  ...
  Jupiter: {
    ...
    Ketu: 'Spiritual fortune and past-life blessings activate. Per BPHS: "The native develops detachment and gains through spiritual merit." Deep philosophical understanding emerges naturally. Material detachment paradoxically brings unexpected gains. Meditation and spiritual practices become profoundly meaningful. Interest in ancient scriptures, astrology, and moksha-related subjects intensifies.',
  },
  Venus: {
    Sun: 'Creative authority and romantic leadership emerge. Per Horasara: "The native gains fame, royal favor, and association with cultured persons." Career in arts or entertainment is favored. Marriage receives positive attention. Financial comfort through prestigious sources. Social standing improves considerably.',
    Moon: 'Emotional beauty and creative nurturing define this period. Per BPHS: "The native acquires white garments, gems, and the company of loving women." Romantic relationships deepen. Artistic expression reaches emotional depths. Financial gains through women, public-facing ventures, or the hospitality industry.',
    Mars: 'Passionate creativity and relationship intensity increase. Per Horasara: "The native acquires landed property and conveyances but may face quarrels." Property related to luxury succeeds. Artistic ventures require bold initiative. Marriage may experience both passion and occasional friction. Physical energy enhances creative output.',
    Mercury: 'Artistic intellect and business creativity flourish brilliantly. Per BPHS: "The native gains through trade in luxury goods, fine arts, and skilled communication." Financial gains through creative communication. Fashion, design, and media ventures succeed. Social networking brings business opportunities. Learning music or fine arts is highly favorable.',
    Jupiter: 'Love, wisdom, and abundance create a supremely blessed period. Per Horasara: "The native obtains wealth, children, and fulfillment of all desires through righteous means." Marriage harmony reaches its peak. Financial prosperity flows abundantly. Children bring joy and pride. Creative ventures achieve lasting recognition. Spiritual practices become devotional and beautiful.',
    Venus: 'Maximum relationship harmony and luxury during this peak period. Per BPHS: "The native enjoys the finest comforts, vehicles, ornaments, and romantic fulfillment." Peak creative expression and artistic achievement. Financial abundance through beauty, arts, and pleasure industries. Social life flourishes magnificently. Marriage celebrations, anniversaries, and romantic milestones are indicated.',
