...
export const rashiDetails: Record<number, RashiDetail> = {
  0: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Aries is valorous, fond of war, head of an army, skilled in riding, with reddish eyes and round knees. They are quick-witted, fond of travel, easily angered but equally quick to forgive. They acquire wealth through their own effort and are respected for their courage." Per Brihat Jataka: "The person born under Mesha is fond of travel, is heroic, and has a broad forehead."',
  ...
  1: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Taurus has a broad thighs, face, and forehead. They are fond of pleasures, have an attractive physique, and are patient in disposition. They are endowed with lands, cattle, and wealth. Generous and forgiving, they are firm in friendship and strong in constitution." Per Brihat Jataka: "Born under Vrishabha, one is patient, happy, and endowed with good qualities."',
  ...
  2: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Gemini is skilled in scriptures, arts, and music. They are soft-spoken, fond of women, and possess an attractive body. They are wealthy, of dual nature, clever in trade and diplomacy." Per Brihat Jataka: "Born under Mithuna, one is fond of women, skilled in sciences, and of good speech."',
  ...
  3: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Cancer is fond of water, possesses houses and gardens, is disturbed in mind at times, and has a plump body. They are fond of their mother, gain through water-related activities, and are attached to their home and traditions." Per Brihat Jataka: "Born under Karka, one is wealthy, influenced by women, and walks with a swaying gait."',
  ...
  4: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Leo has a broad chest and prominent face. They are bold, proud, and fond of meat and forests. They are generous, have few children, and are irascible. They possess commanding leadership and are honored by the state." Per Brihat Jataka: "Born under Simha, one has a broad face, is proud, and wanders in forests and mountains."',
  ...
  5: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Virgo has a feminine body, is sweet in speech, and well-versed in writing and mathematics. They are modest, learned in arts and sciences, and possess skill in various crafts. They are helpful to others and earn through intellectual pursuits." Per Brihat Jataka: "Born under Kanya, one is modest, skilled in arts, and has a soft body."',
  ...
  6: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Libra is skilled in trade and commerce, worships gods and Brahmins, and is intelligent and wealthy. They are fond of traveling, have an agreeable nature, and excel in weighing and measuring things. They value justice and balance above all." Per Brihat Jataka: "Born under Tula, one is a trader, devoted to the gods, and skilled in scales."',
  ...
  7: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Scorpio has a broad chest, round thighs, and large eyes. They are fierce, bold, and harsh in speech but loyal to friends. They possess hidden strength, interest in occult sciences, and earn through secret or investigative means." Per Brihat Jataka: "Born under Vrishchika, one has round knees and a broad chest, is bold and secretive."',
  ...
  8: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Sagittarius has a long face and prominent nose. They are devoted to gods and teachers, skilled in archery and scriptures, and possess poetic talent. They are truthful, grateful, and fond of walking and outdoor activities." Per Brihat Jataka: "Born under Dhanu, one is skilled in archery, has a beautiful figure, and is righteous."',
  ...
  10: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Aquarius has a tall body and is fond of water. They are of clean habits, truthful in speech, and skilled in sciences. They may face sorrows from women but gain through original thinking and group activities. They are devoted to truth and justice." Per Brihat Jataka: "Born under Kumbha, one is fond of perfumes and water, and speaks truthfully."',
  ...
  11: {
    ...
    classicalDescription: 'Per Saravali Ch. 30: "The native born with Moon in Pisces has a well-proportioned body, bright eyes, and is learned. They are fond of women, skilled in art and music, and overcome enemies through wit rather than force. They gain wealth through water-related activities and possess an innately spiritual nature." Per Brihat Jataka: "Born under Meena, one is fond of the opposite sex, beautiful, and skilled in many arts."',
